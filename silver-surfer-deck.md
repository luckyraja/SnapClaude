# Silver Surfer Deck with Maverick

## Deck Strategy
This is a Silver Surfer deck that focuses on playing powerful 3-cost cards and then boosting them all with Silver Surfer on turn 5 or 6. The deck maximizes value from 3-cost cards while maintaining flexibility and control.

## Deck List (12 cards)

### Core Cards
1. **Silver Surfer** (3-cost) - The key card: On Reveal: Give your other 3-cost cards +2 Power
2. **Maverick** (3-cost) - New acquisition, solid stats for Surfer deck
...
10. **Sera** (5-cost) - Reduces cost of cards in hand, helps play multiple 3-costs
11. **Mockingbird** (5-cost) - Cost reduction based on cards played, good curve
12. **Shang-Chi** (4-cost) - Destroys big threats, essential tech card

## How to Play

### Early Game (Turns 1-3)
- Play your 3-cost cards like Brood, Sebastian Shaw, or Sage
- Brood is excellent early for board presence
- Sebastian Shaw grows stronger the earlier you play him

### Mid Game (Turns 4-5)
- Continue playing 3-cost cards
- If you drew Sera (5-cost), play her on turn 5 to enable multiple 3-costs on turn 6
...
**Deck Code:** Silver Surfer Maverick Build
**Created:** 2025-12-30
**Archetype:** Silver Surfer Control
